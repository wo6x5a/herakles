...
CREATE TABLE `PRODUCT` (
  ...
  `CREATE_OPID` VARCHAR(32) DEFAULT NULL,
  `CREATE_TS` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `LAST_MNT_OPID` VARCHAR(32) DEFAULT NULL,
  `LAST_MNT_TS` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
  `VERSION_CT` BIGINT(20) DEFAULT NULL,
  PRIMARY KEY (`ID`)
